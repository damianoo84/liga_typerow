...
class MeetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $meets = $em->getRepository('AppBundle:Meet')->findAll();
    ...
    {
        $meet = new Meet();
        $form = $this->createForm('AppBundle\Form\MeetType', $meet);
...
//        print_r($meet);
    ...
    {
        $deleteForm = $this->createDeleteForm($meet);
        $editForm = $this->createForm('AppBundle\Form\MeetType', $meet);
